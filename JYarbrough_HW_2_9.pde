...
// All text on the same line is a apart of the comment.
...
// lines long, you nmay prefer to use the syntax for a
// multiline comment

/*
A forward slash followed by a asterisk allows the
comment to continue until the opposite
*/

// All the letters and symbols that are not comments are run 
// by the computer. Because the following lines are not comments, 
// they are run and draw a isplay window of 200 x 200 pixels
size(200, 200);
background(102);
